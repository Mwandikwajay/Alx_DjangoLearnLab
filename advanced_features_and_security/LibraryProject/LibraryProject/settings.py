...
STATIC_URL = '/static/'  # Add the leading slash for proper static file handling

# If you are working in development, Django should look for static files in the following directory:
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # This is where your custom static files (like CSS) are stored
]

# For production, static files will be collected here:
